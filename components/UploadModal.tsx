...
export default function UploadModal({ open, onClose }: UploadModalProps) {
  ...
  const handleUpload = async () => {
    ...
    const endpoint =
      "https://nxt24philippines2.app.n8n.cloud/webhook-test/upload-files";
    ...
    try {
      ...
      await fetch(endpoint, {
        ...
        const processEndpoint =
          "https://nxt24philippines2.app.n8n.cloud/webhook-test/invoice-processing";
        ...
        <DialogContent>
          <Box sx={{ py: 2 }}>
            <Typography variant="body2" color="textSecondary" sx={{ mb: 2 }}>
              Upload files to begin reconciliation. Allowed types: PDF, images,
              Word (.doc/.docx), Excel, CSV. You can select multiple files.
            </Typography>
